package by.vadim.spring.elasticsearch;


import by.vadim.spring.elasticsearch.model.Article;
import by.vadim.spring.elasticsearch.model.Author;
...
public class ArticleIntegrationTest {
    ...
    public void givenSavedDoc_whenTitleUpdated_thenCouldFindByUpdatedTitle() {
        final SearchQuery searchQuery = new NativeSearchQueryBuilder().withQuery(fuzzyQuery("title", "search")).build();
        final List<Article> articles = elasticsearchTemplate.queryForList(searchQuery, Article.class);
